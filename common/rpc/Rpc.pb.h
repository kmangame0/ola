...
const Type Type_MAX = STREAM_REQUEST;
...
class RpcMessage : public ::google::protobuf::Message {
 public:
  ...
  inline ::ola::rpc::Type type() const;
  inline void set_type(::ola::rpc::Type value);
...
template <> struct is_proto_enum< ::ola::rpc::Type> : ::google::protobuf::internal::true_type {};
template <>
